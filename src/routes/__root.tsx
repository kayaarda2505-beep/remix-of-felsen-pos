...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Piratino POS is a modern, touch-optimized point-of-sale system for bars, restaurants, and cafes." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Piratino POS — Modernes Kassensystem" },
      { name: "description", content: "Piratino POS is a modern, touch-optimized point-of-sale system for bars, restaurants, and cafes." },
      { name: "twitter:description", content: "Piratino POS is a modern, touch-optimized point-of-sale system for bars, restaurants, and cafes." },
